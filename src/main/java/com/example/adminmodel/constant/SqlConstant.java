...
public class SqlConstant {
    public static final String PRODUCT_INSERT = "INSERT INTO products ( categoryId, name, description, detail, price, thumbnail," +
            "createdAt, updatedAt, deletedAt, createdBy, updatedBy, deletedBy, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    public static final String PRODUCT_UPDATE = "UPDATE products SET categoryId = ?, name = ?, description = ?, detail = ?, price = ?, thumbnail = ?," +
